...
/**
 * This is the model class for table "simulate_exam_listening".
 *
 * @property int $id
 ...
 * @property string $audio_location 音频当前位置
 ...
 */
class SimulateExamListening extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'simulate_exam_listening';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['score'], 'number'],
            [['audio_location', 'answer'], 'string', 'max' => 2000],
    ...
    /**
     * {@inheritdoc}
     * @return SimulateExamListeningQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new SimulateExamListeningQuery(get_called_class());
    }
}
