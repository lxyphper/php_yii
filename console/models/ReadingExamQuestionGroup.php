...
/**
 * This is the model class for table "reading_exam_question_group".
 *
 ...
 */
class ReadingExamQuestionGroup extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'reading_exam_question_group';
    }
    ...
    /**
     * {@inheritdoc}
     * @return ReadingExamQuestionGroupQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ReadingExamQuestionGroupQuery(get_called_class());
    }
}
